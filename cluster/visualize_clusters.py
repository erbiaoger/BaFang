...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Visualize clustering results in 2D")
    parser.add_argument("--pkl_dir", required=True, help="Directory with grouped pkl files OR a single .pkl file")
    parser.add_argument("--clusters_csv", required=True, help="clusters_raw.csv or clusters_norm.csv")
    ...
    parser.add_argument("--max_points", type=int, default=5000, help="Max points to plot (subsample if larger)")
